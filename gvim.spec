...
Version  : 9.0.1001
Release  : 3230
URL      : https://github.com/vim/vim/archive/v9.0.1001/vim-9.0.1001.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1001/vim-9.0.1001.tar.gz
...
%prep
%setup -q -n vim-9.0.1001
cd %{_builddir}/vim-9.0.1001
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670186807
