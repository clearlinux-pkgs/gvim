...
Version  : 9.0.1284
Release  : 3403
URL      : https://github.com/vim/vim/archive/v9.0.1284/vim-9.0.1284.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1284/vim-9.0.1284.tar.gz
...
%prep
%setup -q -n vim-9.0.1284
cd %{_builddir}/vim-9.0.1284
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675620456
