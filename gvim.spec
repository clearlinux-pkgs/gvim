...
Version  : 9.0.1766
Release  : 3689
URL      : https://github.com/vim/vim/archive/v9.0.1766/vim-9.0.1766.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1766/vim-9.0.1766.tar.gz
...
%prep
%setup -q -n vim-9.0.1766
cd %{_builddir}/vim-9.0.1766
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692552177
