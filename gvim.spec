...
Source0  : https://github.com/vim/vim/archive/v9.0.1337/vim-9.0.1337.tar.gz
...
%prep
%setup -q -n vim-9.0.1337
cd %{_builddir}/vim-9.0.1337
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677001366
