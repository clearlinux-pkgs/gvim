...
Source0  : https://github.com/vim/vim/archive/v9.1.0632/vim-9.1.0632.tar.gz
...
%prep
%setup -q -n vim-9.1.0632
cd %{_builddir}/vim-9.1.0632
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722185690
