...
Source0  : https://github.com/vim/vim/archive/v9.0.1226/vim-9.0.1226.tar.gz
...
%prep
%setup -q -n vim-9.0.1226
cd %{_builddir}/vim-9.0.1226
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674323208
