...
Source0  : https://github.com/vim/vim/archive/v8.1.2298/vim-8.1.2298.tar.gz
...
%prep
%setup -q -n vim-8.1.2298
cd %{_builddir}/vim-8.1.2298
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573670526
...
cp %{_builddir}/vim-8.1.2298/src/libvterm/LICENSE %{buildroot}/usr/share/package-licenses/gvim/9979f112bdecefd99762f24f6af76972c2a3a1a6
cp %{_builddir}/vim-8.1.2298/src/xdiff/COPYING %{buildroot}/usr/share/package-licenses/gvim/65c71b7ff77a59a32247d83a528728637263c1b5
cp %{_builddir}/vim-8.1.2298/src/xpm/COPYRIGHT %{buildroot}/usr/share/package-licenses/gvim/553dde2683f711f77fe79504be0429256223469d
%make_install
