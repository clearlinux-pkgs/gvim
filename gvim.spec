...
Version  : 9.1.0692
Release  : 4099
URL      : https://github.com/vim/vim/archive/v9.1.0692/vim-9.1.0692.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.0692/vim-9.1.0692.tar.gz
...
%prep
%setup -q -n vim-9.1.0692
cd %{_builddir}/vim-9.1.0692
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724496168
