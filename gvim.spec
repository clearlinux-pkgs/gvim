...
Version  : 9.0.1223
Release  : 3358
URL      : https://github.com/vim/vim/archive/v9.0.1223/vim-9.0.1223.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1223/vim-9.0.1223.tar.gz
...
%prep
%setup -q -n vim-9.0.1223
cd %{_builddir}/vim-9.0.1223
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674237085
