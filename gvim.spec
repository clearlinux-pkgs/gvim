...
Source0  : https://github.com/vim/vim/archive/v9.0.1575/vim-9.0.1575.tar.gz
...
%prep
%setup -q -n vim-9.0.1575
cd %{_builddir}/vim-9.0.1575
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684862917
