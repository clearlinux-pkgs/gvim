...
Source0  : https://github.com/vim/vim/archive/v9.0.1735/vim-9.0.1735.tar.gz
...
%prep
%setup -q -n vim-9.0.1735
cd %{_builddir}/vim-9.0.1735
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692312304
