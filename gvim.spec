...
Version  : 9.0.1053
Release  : 3252
URL      : https://github.com/vim/vim/archive/v9.0.1053/vim-9.0.1053.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1053/vim-9.0.1053.tar.gz
...
%prep
%setup -q -n vim-9.0.1053
cd %{_builddir}/vim-9.0.1053
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670964347
