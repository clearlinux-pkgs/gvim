...
Source0  : https://github.com/vim/vim/archive/v9.0.2090/vim-9.0.2090.tar.gz
...
%prep
%setup -q -n vim-9.0.2090
cd %{_builddir}/vim-9.0.2090
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699094726
