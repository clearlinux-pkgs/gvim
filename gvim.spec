...
Source0  : https://github.com/vim/vim/archive/v9.0.1222/vim-9.0.1222.tar.gz
...
%prep
%setup -q -n vim-9.0.1222
cd %{_builddir}/vim-9.0.1222
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674161054
