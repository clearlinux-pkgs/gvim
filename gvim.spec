...
Version  : 9.0.0121
Release  : 2737
URL      : https://github.com/vim/vim/archive/v9.0.0121/vim-9.0.0121.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0121/vim-9.0.0121.tar.gz
...
%prep
%setup -q -n vim-9.0.0121
cd %{_builddir}/vim-9.0.0121
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659285593
