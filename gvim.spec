...
Version  : 9.0.0349
Release  : 2854
URL      : https://github.com/vim/vim/archive/v9.0.0349/vim-9.0.0349.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0349/vim-9.0.0349.tar.gz
...
%prep
%setup -q -n vim-9.0.0349
cd %{_builddir}/vim-9.0.0349
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662042044
