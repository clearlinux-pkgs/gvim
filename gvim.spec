...
Source0  : https://github.com/vim/vim/archive/v9.0.0660/vim-9.0.0660.tar.gz
...
%prep
%setup -q -n vim-9.0.0660
cd %{_builddir}/vim-9.0.0660
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664912714
