...
Source0  : https://github.com/vim/vim/archive/v9.0.1854/vim-9.0.1854.tar.gz
...
%prep
%setup -q -n vim-9.0.1854
cd %{_builddir}/vim-9.0.1854
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693727221
