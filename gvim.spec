...
Source0  : https://github.com/vim/vim/archive/v9.0.2149/vim-9.0.2149.tar.gz
...
%prep
%setup -q -n vim-9.0.2149
cd %{_builddir}/vim-9.0.2149
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701733776
