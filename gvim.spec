...
Version  : 9.0.0998
Release  : 3227
URL      : https://github.com/vim/vim/archive/v9.0.0998/vim-9.0.0998.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0998/vim-9.0.0998.tar.gz
...
%prep
%setup -q -n vim-9.0.0998
cd %{_builddir}/vim-9.0.0998
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670069219
