...
Version  : 9.0.0707
Release  : 3040
URL      : https://github.com/vim/vim/archive/v9.0.0707/vim-9.0.0707.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0707/vim-9.0.0707.tar.gz
...
%prep
%setup -q -n vim-9.0.0707
cd %{_builddir}/vim-9.0.0707
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665333780
