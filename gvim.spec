...
Version  : 9.0.0823
Release  : 3108
URL      : https://github.com/vim/vim/archive/v9.0.0823/vim-9.0.0823.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0823/vim-9.0.0823.tar.gz
...
%prep
%setup -q -n vim-9.0.0823
cd %{_builddir}/vim-9.0.0823
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667266999
