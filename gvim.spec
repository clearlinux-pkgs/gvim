...
Version  : 9.0.0927
Release  : 3182
URL      : https://github.com/vim/vim/archive/v9.0.0927/vim-9.0.0927.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0927/vim-9.0.0927.tar.gz
...
%prep
%setup -q -n vim-9.0.0927
cd %{_builddir}/vim-9.0.0927
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669205202
