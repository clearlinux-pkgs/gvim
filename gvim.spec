...
Source0  : https://github.com/vim/vim/archive/v9.0.1607/vim-9.0.1607.tar.gz
...
%prep
%setup -q -n vim-9.0.1607
cd %{_builddir}/vim-9.0.1607
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685907745
