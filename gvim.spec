...
Version  : 9.0.0700
Release  : 3037
URL      : https://github.com/vim/vim/archive/v9.0.0700/vim-9.0.0700.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0700/vim-9.0.0700.tar.gz
...
%prep
%setup -q -n vim-9.0.0700
cd %{_builddir}/vim-9.0.0700
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665257785
