...
Source0  : https://github.com/vim/vim/archive/v9.0.1531/vim-9.0.1531.tar.gz
...
%prep
%setup -q -n vim-9.0.1531
cd %{_builddir}/vim-9.0.1531
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683650673
