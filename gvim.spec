...
Version  : 9.0.1736
Release  : 3681
URL      : https://github.com/vim/vim/archive/v9.0.1736/vim-9.0.1736.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1736/vim-9.0.1736.tar.gz
...
%prep
%setup -q -n vim-9.0.1736
cd %{_builddir}/vim-9.0.1736
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692323233
