...
Source0  : https://github.com/vim/vim/archive/v9.0.1439/vim-9.0.1439.tar.gz
...
%prep
%setup -q -n vim-9.0.1439
cd %{_builddir}/vim-9.0.1439
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680545995
