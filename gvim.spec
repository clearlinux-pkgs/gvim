...
Version  : 9.0.1712
Release  : 3677
URL      : https://github.com/vim/vim/archive/v9.0.1712/vim-9.0.1712.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1712/vim-9.0.1712.tar.gz
...
%prep
%setup -q -n vim-9.0.1712
cd %{_builddir}/vim-9.0.1712
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691956334
