...
Source0  : https://github.com/vim/vim/archive/v9.0.1247/vim-9.0.1247.tar.gz
...
%prep
%setup -q -n vim-9.0.1247
cd %{_builddir}/vim-9.0.1247
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674744216
