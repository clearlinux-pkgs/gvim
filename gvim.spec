...
Version  : 9.1.1020
Release  : 4239
URL      : https://github.com/vim/vim/archive/v9.1.1020/vim-9.1.1020.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.1020/vim-9.1.1020.tar.gz
...
%prep
%setup -q -n vim-9.1.1020
cd %{_builddir}/vim-9.1.1020
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737039011
