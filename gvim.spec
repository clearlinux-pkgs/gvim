...
Source0  : https://github.com/vim/vim/archive/v9.0.1067/vim-9.0.1067.tar.gz
...
%prep
%setup -q -n vim-9.0.1067
cd %{_builddir}/vim-9.0.1067
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671280860
