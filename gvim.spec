...
Version  : 9.0.1205
Release  : 3346
URL      : https://github.com/vim/vim/archive/v9.0.1205/vim-9.0.1205.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1205/vim-9.0.1205.tar.gz
...
%prep
%setup -q -n vim-9.0.1205
cd %{_builddir}/vim-9.0.1205
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673817103
