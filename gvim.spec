...
Version  : 9.0.1047
Release  : 3248
URL      : https://github.com/vim/vim/archive/v9.0.1047/vim-9.0.1047.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1047/vim-9.0.1047.tar.gz
...
%prep
%setup -q -n vim-9.0.1047
cd %{_builddir}/vim-9.0.1047
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670769734
