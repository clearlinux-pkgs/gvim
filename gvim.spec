...
Source0  : https://github.com/vim/vim/archive/v9.0.0317/vim-9.0.0317.tar.gz
...
%prep
%setup -q -n vim-9.0.0317
cd %{_builddir}/vim-9.0.0317
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661780564
