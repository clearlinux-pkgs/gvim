...
Version  : 9.0.0650
Release  : 3003
URL      : https://github.com/vim/vim/archive/v9.0.0650/vim-9.0.0650.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0650/vim-9.0.0650.tar.gz
...
%prep
%setup -q -n vim-9.0.0650
cd %{_builddir}/vim-9.0.0650
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664815089
