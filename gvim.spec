...
Version  : 9.0.0769
Release  : 3077
URL      : https://github.com/vim/vim/archive/v9.0.0769/vim-9.0.0769.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0769/vim-9.0.0769.tar.gz
...
%prep
%setup -q -n vim-9.0.0769
cd %{_builddir}/vim-9.0.0769
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665874132
