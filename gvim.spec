...
Source0  : https://github.com/vim/vim/archive/v9.0.0991/vim-9.0.0991.tar.gz
...
%prep
%setup -q -n vim-9.0.0991
cd %{_builddir}/vim-9.0.0991
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670003484
