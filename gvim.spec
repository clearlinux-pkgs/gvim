...
Version  : 9.1.0634
Release  : 4070
URL      : https://github.com/vim/vim/archive/v9.1.0634/vim-9.1.0634.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.0634/vim-9.1.0634.tar.gz
...
%prep
%setup -q -n vim-9.1.0634
cd %{_builddir}/vim-9.1.0634
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722196368
