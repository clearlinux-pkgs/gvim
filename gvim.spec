...
Version  : 9.0.0410
Release  : 2881
URL      : https://github.com/vim/vim/archive/v9.0.0410/vim-9.0.0410.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0410/vim-9.0.0410.tar.gz
...
%prep
%setup -q -n vim-9.0.0410
cd %{_builddir}/vim-9.0.0410
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662580239
