...
Version  : 9.0.2143
Release  : 3816
URL      : https://github.com/vim/vim/archive/v9.0.2143/vim-9.0.2143.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.2143/vim-9.0.2143.tar.gz
...
%prep
%setup -q -n vim-9.0.2143
cd %{_builddir}/vim-9.0.2143
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701455976
