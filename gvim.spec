...
Source0  : https://github.com/vim/vim/archive/v9.0.1282/vim-9.0.1282.tar.gz
...
%prep
%setup -q -n vim-9.0.1282
cd %{_builddir}/vim-9.0.1282
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675609259
