...
Version  : 9.0.1629
Release  : 3630
URL      : https://github.com/vim/vim/archive/v9.0.1629/vim-9.0.1629.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1629/vim-9.0.1629.tar.gz
...
%prep
%setup -q -n vim-9.0.1629
cd %{_builddir}/vim-9.0.1629
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686749984
