...
Version  : 9.0.0443
Release  : 2898
URL      : https://github.com/vim/vim/archive/v9.0.0443/vim-9.0.0443.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0443/vim-9.0.0443.tar.gz
...
%prep
%setup -q -n vim-9.0.0443
cd %{_builddir}/vim-9.0.0443
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662903708
