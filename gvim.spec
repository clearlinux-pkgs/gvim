...
Version  : 9.1.0685
Release  : 4093
URL      : https://github.com/vim/vim/archive/v9.1.0685/vim-9.1.0685.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.0685/vim-9.1.0685.tar.gz
...
%prep
%setup -q -n vim-9.1.0685
cd %{_builddir}/vim-9.1.0685
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724184389
