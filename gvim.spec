...
Source0  : https://github.com/vim/vim/archive/v9.0.1202/vim-9.0.1202.tar.gz
...
%prep
%setup -q -n vim-9.0.1202
cd %{_builddir}/vim-9.0.1202
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673804990
