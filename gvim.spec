...
Source0  : https://github.com/vim/vim/archive/v9.0.0256/vim-9.0.0256.tar.gz
...
%prep
%setup -q -n vim-9.0.0256
cd %{_builddir}/vim-9.0.0256
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661359326
