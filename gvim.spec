...
Source0  : https://github.com/vim/vim/archive/v9.1.0964/vim-9.1.0964.tar.gz
...
%prep
%setup -q -n vim-9.1.0964
cd %{_builddir}/vim-9.1.0964
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735238661
