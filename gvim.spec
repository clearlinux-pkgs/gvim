...
Source0  : https://github.com/vim/vim/archive/v9.1.1236/vim-9.1.1236.tar.gz
...
%prep
%setup -q -n vim-9.1.1236
cd %{_builddir}/vim-9.1.1236
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742847962
