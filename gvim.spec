...
Source0  : https://github.com/vim/vim/archive/v9.1.1365/vim-9.1.1365.tar.gz
...
%prep
%setup -q -n vim-9.1.1365
cd %{_builddir}/vim-9.1.1365
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746390093
