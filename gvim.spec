...
Source0  : https://github.com/vim/vim/archive/v9.0.1584/vim-9.0.1584.tar.gz
...
%prep
%setup -q -n vim-9.0.1584
cd %{_builddir}/vim-9.0.1584
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685217096
