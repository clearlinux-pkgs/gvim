...
Source0  : https://github.com/vim/vim/archive/v9.0.1645/vim-9.0.1645.tar.gz
...
%prep
%setup -q -n vim-9.0.1645
cd %{_builddir}/vim-9.0.1645
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687442609
