...
Source0  : https://github.com/vim/vim/archive/v9.0.0967/vim-9.0.0967.tar.gz
...
%prep
%setup -q -n vim-9.0.0967
cd %{_builddir}/vim-9.0.0967
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669669538
