...
Source0  : https://github.com/vim/vim/archive/v9.0.1192/vim-9.0.1192.tar.gz
...
%prep
%setup -q -n vim-9.0.1192
cd %{_builddir}/vim-9.0.1192
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673634520
