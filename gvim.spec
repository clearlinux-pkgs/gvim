...
Version  : 9.0.0690
Release  : 3031
URL      : https://github.com/vim/vim/archive/v9.0.0690/vim-9.0.0690.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0690/vim-9.0.0690.tar.gz
...
%prep
%setup -q -n vim-9.0.0690
cd %{_builddir}/vim-9.0.0690
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665225849
