...
Source0  : https://github.com/vim/vim/archive/v9.0.1328/vim-9.0.1328.tar.gz
...
%prep
%setup -q -n vim-9.0.1328
cd %{_builddir}/vim-9.0.1328
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676841098
