...
Version  : 9.0.0305
Release  : 2826
URL      : https://github.com/vim/vim/archive/v9.0.0305/vim-9.0.0305.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0305/vim-9.0.0305.tar.gz
...
%prep
%setup -q -n vim-9.0.0305
cd %{_builddir}/vim-9.0.0305
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661715788
