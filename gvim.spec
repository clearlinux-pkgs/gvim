...
Version  : 9.1.0244
Release  : 3928
URL      : https://github.com/vim/vim/archive/v9.1.0244/vim-9.1.0244.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.0244/vim-9.1.0244.tar.gz
...
%prep
%setup -q -n vim-9.1.0244
cd %{_builddir}/vim-9.1.0244
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711906604
