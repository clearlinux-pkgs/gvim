...
Version  : 9.0.1806
Release  : 3704
URL      : https://github.com/vim/vim/archive/v9.0.1806/vim-9.0.1806.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1806/vim-9.0.1806.tar.gz
...
%prep
%setup -q -n vim-9.0.1806
cd %{_builddir}/vim-9.0.1806
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693158310
