...
Source0  : https://github.com/vim/vim/archive/v9.0.1578/vim-9.0.1578.tar.gz
...
%prep
%setup -q -n vim-9.0.1578
cd %{_builddir}/vim-9.0.1578
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685033154
