...
Version  : 9.0.0208
Release  : 2786
URL      : https://github.com/vim/vim/archive/v9.0.0208/vim-9.0.0208.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0208/vim-9.0.0208.tar.gz
...
%prep
%setup -q -n vim-9.0.0208
cd %{_builddir}/vim-9.0.0208
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660492410
