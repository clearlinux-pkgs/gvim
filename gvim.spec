...
Source0  : https://github.com/vim/vim/archive/v9.0.1783/vim-9.0.1783.tar.gz
...
%prep
%setup -q -n vim-9.0.1783
cd %{_builddir}/vim-9.0.1783
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692736625
