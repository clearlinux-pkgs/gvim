...
Source0  : https://github.com/vim/vim/archive/v9.0.0896/vim-9.0.0896.tar.gz
...
%prep
%setup -q -n vim-9.0.0896
cd %{_builddir}/vim-9.0.0896
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668707513
