...
Version  : 9.0.0960
Release  : 3202
URL      : https://github.com/vim/vim/archive/v9.0.0960/vim-9.0.0960.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0960/vim-9.0.0960.tar.gz
...
%prep
%setup -q -n vim-9.0.0960
cd %{_builddir}/vim-9.0.0960
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669571229
