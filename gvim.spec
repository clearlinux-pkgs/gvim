...
Source0  : https://github.com/vim/vim/archive/v9.1.0478/vim-9.1.0478.tar.gz
...
%prep
%setup -q -n vim-9.1.0478
cd %{_builddir}/vim-9.1.0478
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718223647
