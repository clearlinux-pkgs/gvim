...
Source0  : https://github.com/vim/vim/archive/v9.1.0708/vim-9.1.0708.tar.gz
...
%prep
%setup -q -n vim-9.1.0708
cd %{_builddir}/vim-9.1.0708
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725187904
