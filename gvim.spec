...
Version  : 9.1.1238
Release  : 4318
URL      : https://github.com/vim/vim/archive/v9.1.1238/vim-9.1.1238.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.1238/vim-9.1.1238.tar.gz
...
%prep
%setup -q -n vim-9.1.1238
cd %{_builddir}/vim-9.1.1238
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742932232
