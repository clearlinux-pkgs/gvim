...
Source0  : https://github.com/vim/vim/archive/v9.0.1481/vim-9.0.1481.tar.gz
...
%prep
%setup -q -n vim-9.0.1481
cd %{_builddir}/vim-9.0.1481
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682269969
