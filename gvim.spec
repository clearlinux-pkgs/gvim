...
Source0  : https://github.com/vim/vim/archive/v9.0.1025/vim-9.0.1025.tar.gz
...
%prep
%setup -q -n vim-9.0.1025
cd %{_builddir}/vim-9.0.1025
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670413458
