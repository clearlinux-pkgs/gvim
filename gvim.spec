...
Source0  : https://github.com/vim/vim/archive/v9.0.0922/vim-9.0.0922.tar.gz
...
%prep
%setup -q -n vim-9.0.0922
cd %{_builddir}/vim-9.0.0922
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669149714
