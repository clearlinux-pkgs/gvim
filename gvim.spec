...
Version  : 9.0.0928
Release  : 3183
URL      : https://github.com/vim/vim/archive/v9.0.0928/vim-9.0.0928.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0928/vim-9.0.0928.tar.gz
...
%prep
%setup -q -n vim-9.0.0928
cd %{_builddir}/vim-9.0.0928
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669206071
