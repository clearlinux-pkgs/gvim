...
Version  : 9.0.0687
Release  : 3028
URL      : https://github.com/vim/vim/archive/v9.0.0687/vim-9.0.0687.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0687/vim-9.0.0687.tar.gz
...
%prep
%setup -q -n vim-9.0.0687
cd %{_builddir}/vim-9.0.0687
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665160923
