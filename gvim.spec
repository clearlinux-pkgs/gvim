...
Source0  : https://github.com/vim/vim/archive/v9.0.1172/vim-9.0.1172.tar.gz
...
%prep
%setup -q -n vim-9.0.1172
cd %{_builddir}/vim-9.0.1172
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673372838
