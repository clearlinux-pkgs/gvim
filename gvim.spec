...
Version  : 9.0.1628
Release  : 3629
URL      : https://github.com/vim/vim/archive/v9.0.1628/vim-9.0.1628.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1628/vim-9.0.1628.tar.gz
...
%prep
%setup -q -n vim-9.0.1628
cd %{_builddir}/vim-9.0.1628
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686696312
