...
%prep
%setup -q -n vim-8.1.2323
cd %{_builddir}/vim-8.1.2323
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574275455
...
cp %{_builddir}/vim-8.1.2323/src/libvterm/LICENSE %{buildroot}/usr/share/package-licenses/gvim/9979f112bdecefd99762f24f6af76972c2a3a1a6
cp %{_builddir}/vim-8.1.2323/src/xdiff/COPYING %{buildroot}/usr/share/package-licenses/gvim/65c71b7ff77a59a32247d83a528728637263c1b5
cp %{_builddir}/vim-8.1.2323/src/xpm/COPYRIGHT %{buildroot}/usr/share/package-licenses/gvim/553dde2683f711f77fe79504be0429256223469d
%make_install
