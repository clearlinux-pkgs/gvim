...
Source0  : https://github.com/vim/vim/archive/v9.0.0839/vim-9.0.0839.tar.gz
...
%prep
%setup -q -n vim-9.0.0839
cd %{_builddir}/vim-9.0.0839
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667745951
