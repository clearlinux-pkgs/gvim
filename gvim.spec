...
Source0  : https://github.com/vim/vim/archive/v9.0.0209/vim-9.0.0209.tar.gz
...
%prep
%setup -q -n vim-9.0.0209
cd %{_builddir}/vim-9.0.0209
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660494182
