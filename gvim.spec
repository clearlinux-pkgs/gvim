...
Version  : 9.0.1437
Release  : 3514
URL      : https://github.com/vim/vim/archive/v9.0.1437/vim-9.0.1437.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1437/vim-9.0.1437.tar.gz
...
%prep
%setup -q -n vim-9.0.1437
cd %{_builddir}/vim-9.0.1437
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680513698
