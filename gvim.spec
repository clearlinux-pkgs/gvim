...
Source0  : https://github.com/vim/vim/archive/v9.0.1116/vim-9.0.1116.tar.gz
...
%prep
%setup -q -n vim-9.0.1116
cd %{_builddir}/vim-9.0.1116
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672433104
