...
Source0  : https://github.com/vim/vim/archive/v8.2.4931/vim-8.2.4931.tar.gz
...
%prep
%setup -q -n vim-8.2.4931
cd %{_builddir}/vim-8.2.4931
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652190283
...
cp %{_builddir}/vim-8.2.4931/LICENSE %{buildroot}/usr/share/package-licenses/gvim/100dd019c7d2912226c94666cac0f93eeb82a518
cp %{_builddir}/vim-8.2.4931/src/libvterm/LICENSE %{buildroot}/usr/share/package-licenses/gvim/9979f112bdecefd99762f24f6af76972c2a3a1a6
cp %{_builddir}/vim-8.2.4931/src/xdiff/COPYING %{buildroot}/usr/share/package-licenses/gvim/65c71b7ff77a59a32247d83a528728637263c1b5
cp %{_builddir}/vim-8.2.4931/src/xpm/COPYRIGHT %{buildroot}/usr/share/package-licenses/gvim/553dde2683f711f77fe79504be0429256223469d
%make_install
