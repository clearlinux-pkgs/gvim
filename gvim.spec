...
Source0  : https://github.com/vim/vim/archive/v9.0.1651/vim-9.0.1651.tar.gz
...
%prep
%setup -q -n vim-9.0.1651
cd %{_builddir}/vim-9.0.1651
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687549893
