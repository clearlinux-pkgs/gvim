...
Source0  : https://github.com/vim/vim/archive/v9.0.0752/vim-9.0.0752.tar.gz
...
%prep
%setup -q -n vim-9.0.0752
cd %{_builddir}/vim-9.0.0752
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665776896
