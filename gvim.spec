...
Version  : 9.0.0279
Release  : 2816
URL      : https://github.com/vim/vim/archive/v9.0.0279/vim-9.0.0279.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0279/vim-9.0.0279.tar.gz
...
%prep
%setup -q -n vim-9.0.0279
cd %{_builddir}/vim-9.0.0279
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661532127
