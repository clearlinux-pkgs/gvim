...
Version  : 9.0.0713
Release  : 3043
URL      : https://github.com/vim/vim/archive/v9.0.0713/vim-9.0.0713.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0713/vim-9.0.0713.tar.gz
...
%prep
%setup -q -n vim-9.0.0713
cd %{_builddir}/vim-9.0.0713
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665409169
