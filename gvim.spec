...
Version  : 9.0.2122
Release  : 3807
URL      : https://github.com/vim/vim/archive/v9.0.2122/vim-9.0.2122.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.2122/vim-9.0.2122.tar.gz
...
%prep
%setup -q -n vim-9.0.2122
cd %{_builddir}/vim-9.0.2122
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700707479
