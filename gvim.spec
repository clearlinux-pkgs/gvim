...
Version  : 9.0.2160
Release  : 3823
URL      : https://github.com/vim/vim/archive/v9.0.2160/vim-9.0.2160.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.2160/vim-9.0.2160.tar.gz
...
%prep
%setup -q -n vim-9.0.2160
cd %{_builddir}/vim-9.0.2160
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702403166
