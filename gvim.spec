...
Source0  : https://github.com/vim/vim/archive/v9.0.1073/vim-9.0.1073.tar.gz
...
%prep
%setup -q -n vim-9.0.1073
cd %{_builddir}/vim-9.0.1073
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671396490
