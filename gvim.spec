...
Version  : 9.0.0578
Release  : 2961
URL      : https://github.com/vim/vim/archive/v9.0.0578/vim-9.0.0578.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0578/vim-9.0.0578.tar.gz
...
%prep
%setup -q -n vim-9.0.0578
cd %{_builddir}/vim-9.0.0578
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664039528
