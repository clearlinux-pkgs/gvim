...
Source0  : https://github.com/vim/vim/archive/v9.1.1518/vim-9.1.1518.tar.gz
...
%prep
%setup -q -n vim-9.1.1518
cd %{_builddir}/vim-9.1.1518
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751897187
