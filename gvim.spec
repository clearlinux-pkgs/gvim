...
Version  : 9.0.1390
Release  : 3483
URL      : https://github.com/vim/vim/archive/v9.0.1390/vim-9.0.1390.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1390/vim-9.0.1390.tar.gz
...
%prep
%setup -q -n vim-9.0.1390
cd %{_builddir}/vim-9.0.1390
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678211366
