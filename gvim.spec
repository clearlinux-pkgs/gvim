...
Source0  : https://github.com/vim/vim/archive/v9.0.2190/vim-9.0.2190.tar.gz
...
%prep
%setup -q -n vim-9.0.2190
cd %{_builddir}/vim-9.0.2190
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704142436
