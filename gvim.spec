...
Version  : 9.0.1679
Release  : 3666
URL      : https://github.com/vim/vim/archive/v9.0.1679/vim-9.0.1679.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1679/vim-9.0.1679.tar.gz
...
%prep
%setup -q -n vim-9.0.1679
cd %{_builddir}/vim-9.0.1679
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691524193
