...
Source0  : https://github.com/vim/vim/archive/v9.0.0945/vim-9.0.0945.tar.gz
...
%prep
%setup -q -n vim-9.0.0945
cd %{_builddir}/vim-9.0.0945
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669333724
