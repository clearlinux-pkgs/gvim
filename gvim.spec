...
Source0  : https://github.com/vim/vim/archive/v9.0.1395/vim-9.0.1395.tar.gz
...
%prep
%setup -q -n vim-9.0.1395
cd %{_builddir}/vim-9.0.1395
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678310147
