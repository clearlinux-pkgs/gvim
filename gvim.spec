...
Source0  : https://github.com/vim/vim/archive/v9.0.1668/vim-9.0.1668.tar.gz
...
%prep
%setup -q -n vim-9.0.1668
cd %{_builddir}/vim-9.0.1668
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687822796
