...
Source0  : https://github.com/vim/vim/archive/v9.0.0369/vim-9.0.0369.tar.gz
...
%prep
%setup -q -n vim-9.0.0369
cd %{_builddir}/vim-9.0.0369
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662212998
