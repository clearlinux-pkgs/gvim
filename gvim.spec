...
Version  : 9.0.0933
Release  : 3186
URL      : https://github.com/vim/vim/archive/v9.0.0933/vim-9.0.0933.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0933/vim-9.0.0933.tar.gz
...
%prep
%setup -q -n vim-9.0.0933
cd %{_builddir}/vim-9.0.0933
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669247058
