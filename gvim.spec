...
Version  : 9.0.1327
Release  : 3438
URL      : https://github.com/vim/vim/archive/v9.0.1327/vim-9.0.1327.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1327/vim-9.0.1327.tar.gz
...
%prep
%setup -q -n vim-9.0.1327
cd %{_builddir}/vim-9.0.1327
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676839793
