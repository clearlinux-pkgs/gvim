...
Version  : 9.1.1301
Release  : 4339
URL      : https://github.com/vim/vim/archive/v9.1.1301/vim-9.1.1301.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.1301/vim-9.1.1301.tar.gz
...
%prep
%setup -q -n vim-9.1.1301
cd %{_builddir}/vim-9.1.1301
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744671066
