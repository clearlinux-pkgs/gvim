...
Version  : 9.0.0143
Release  : 2748
URL      : https://github.com/vim/vim/archive/v9.0.0143/vim-9.0.0143.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0143/vim-9.0.0143.tar.gz
...
%prep
%setup -q -n vim-9.0.0143
cd %{_builddir}/vim-9.0.0143
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659707123
