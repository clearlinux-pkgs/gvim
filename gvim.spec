...
Source0  : https://github.com/vim/vim/archive/v9.0.1140/vim-9.0.1140.tar.gz
...
%prep
%setup -q -n vim-9.0.1140
cd %{_builddir}/vim-9.0.1140
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672778698
