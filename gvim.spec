...
Source0  : https://github.com/vim/vim/archive/v9.0.1562/vim-9.0.1562.tar.gz
...
%prep
%setup -q -n vim-9.0.1562
cd %{_builddir}/vim-9.0.1562
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684266272
