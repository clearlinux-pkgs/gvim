...
Source0  : https://github.com/vim/vim/archive/v9.1.0228/vim-9.1.0228.tar.gz
...
%prep
%setup -q -n vim-9.1.0228
cd %{_builddir}/vim-9.1.0228
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711709359
