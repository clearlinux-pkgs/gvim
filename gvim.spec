...
Source0  : https://github.com/vim/vim/archive/v9.1.1233/vim-9.1.1233.tar.gz
...
%prep
%setup -q -n vim-9.1.1233
cd %{_builddir}/vim-9.1.1233
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742845872
