...
Version  : 9.1.0185
Release  : 3907
URL      : https://github.com/vim/vim/archive/v9.1.0185/vim-9.1.0185.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.0185/vim-9.1.0185.tar.gz
...
%prep
%setup -q -n vim-9.1.0185
cd %{_builddir}/vim-9.1.0185
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710672158
