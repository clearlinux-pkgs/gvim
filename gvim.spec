...
Source0  : https://github.com/vim/vim/archive/v9.1.1251/vim-9.1.1251.tar.gz
...
%prep
%setup -q -n vim-9.1.1251
cd %{_builddir}/vim-9.1.1251
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743105389
