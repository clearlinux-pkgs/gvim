...
Version  : 9.0.1139
Release  : 3307
URL      : https://github.com/vim/vim/archive/v9.0.1139/vim-9.0.1139.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1139/vim-9.0.1139.tar.gz
...
%prep
%setup -q -n vim-9.0.1139
cd %{_builddir}/vim-9.0.1139
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672757355
