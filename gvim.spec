...
Version  : 9.0.1510
Release  : 3553
URL      : https://github.com/vim/vim/archive/v9.0.1510/vim-9.0.1510.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1510/vim-9.0.1510.tar.gz
...
%prep
%setup -q -n vim-9.0.1510
cd %{_builddir}/vim-9.0.1510
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683326912
