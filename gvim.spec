...
Source0  : https://github.com/vim/vim/archive/v9.0.1082/vim-9.0.1082.tar.gz
...
%prep
%setup -q -n vim-9.0.1082
cd %{_builddir}/vim-9.0.1082
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671486877
