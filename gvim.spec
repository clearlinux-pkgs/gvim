...
Source0  : https://github.com/vim/vim/archive/v8.2.5129/vim-8.2.5129.tar.gz
...
%prep
%setup -q -n vim-8.2.5129
cd %{_builddir}/vim-8.2.5129
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655647505
...
cp %{_builddir}/vim-8.2.5129/LICENSE %{buildroot}/usr/share/package-licenses/gvim/100dd019c7d2912226c94666cac0f93eeb82a518
cp %{_builddir}/vim-8.2.5129/src/libvterm/LICENSE %{buildroot}/usr/share/package-licenses/gvim/9979f112bdecefd99762f24f6af76972c2a3a1a6
cp %{_builddir}/vim-8.2.5129/src/xdiff/COPYING %{buildroot}/usr/share/package-licenses/gvim/65c71b7ff77a59a32247d83a528728637263c1b5
cp %{_builddir}/vim-8.2.5129/src/xpm/COPYRIGHT %{buildroot}/usr/share/package-licenses/gvim/553dde2683f711f77fe79504be0429256223469d
%make_install
