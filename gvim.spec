...
Source0  : https://github.com/vim/vim/archive/v8.2.3510/vim-8.2.3510.tar.gz
...
%prep
%setup -q -n vim-8.2.3510
cd %{_builddir}/vim-8.2.3510
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634252803
...
cp %{_builddir}/vim-8.2.3510/LICENSE %{buildroot}/usr/share/package-licenses/gvim/100dd019c7d2912226c94666cac0f93eeb82a518
cp %{_builddir}/vim-8.2.3510/src/libvterm/LICENSE %{buildroot}/usr/share/package-licenses/gvim/9979f112bdecefd99762f24f6af76972c2a3a1a6
cp %{_builddir}/vim-8.2.3510/src/xdiff/COPYING %{buildroot}/usr/share/package-licenses/gvim/65c71b7ff77a59a32247d83a528728637263c1b5
cp %{_builddir}/vim-8.2.3510/src/xpm/COPYRIGHT %{buildroot}/usr/share/package-licenses/gvim/553dde2683f711f77fe79504be0429256223469d
%make_install
...
touch %{buildroot}/usr/share/clear/packages/gvim
touch %{buildroot}/usr/share/clear/packages/gvim-bin
touch %{buildroot}/usr/share/clear/packages/gvim-data
touch %{buildroot}/usr/share/clear/packages/gvim-license

%files
%defattr(-,root,root,-)
/usr/share/clear/packages/gvim
...
/usr/bin/gvimdiff
/usr/bin/gvimtutor
/usr/share/clear/packages/gvim-bin

%files data
%defattr(-,root,root,-)
/usr/share/applications/gvim.desktop
/usr/share/clear/packages/gvim-data

%files license
%defattr(0644,root,root,0755)
/usr/share/clear/packages/gvim-license
