...
Source0  : https://github.com/vim/vim/archive/v9.0.1233/vim-9.0.1233.tar.gz
...
%prep
%setup -q -n vim-9.0.1233
cd %{_builddir}/vim-9.0.1233
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674420543
