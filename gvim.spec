...
Source0  : https://github.com/vim/vim/archive/v9.0.1425/vim-9.0.1425.tar.gz
...
%prep
%setup -q -n vim-9.0.1425
cd %{_builddir}/vim-9.0.1425
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679589842
