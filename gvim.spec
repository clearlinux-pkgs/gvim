...
Version  : 9.1.0274
Release  : 3938
URL      : https://github.com/vim/vim/archive/v9.1.0274/vim-9.1.0274.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.0274/vim-9.1.0274.tar.gz
...
%prep
%setup -q -n vim-9.1.0274
cd %{_builddir}/vim-9.1.0274
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712510374
