...
Version  : 9.0.0717
Release  : 3046
URL      : https://github.com/vim/vim/archive/v9.0.0717/vim-9.0.0717.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0717/vim-9.0.0717.tar.gz
...
%prep
%setup -q -n vim-9.0.0717
cd %{_builddir}/vim-9.0.0717
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665432798
