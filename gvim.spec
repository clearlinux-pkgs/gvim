...
Source0  : https://github.com/vim/vim/archive/v9.0.1237/vim-9.0.1237.tar.gz
...
%prep
%setup -q -n vim-9.0.1237
cd %{_builddir}/vim-9.0.1237
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674517613
