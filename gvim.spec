...
Source0  : https://github.com/vim/vim/archive/v9.0.1392/vim-9.0.1392.tar.gz
...
%prep
%setup -q -n vim-9.0.1392
cd %{_builddir}/vim-9.0.1392
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678232523
